...
usage() {
  this=$1
  cat <<EOF
$this: download go binaries for h4ux/ctree

Usage: $this [-b] bindir [-d] [tag]
  -b sets bindir or installation directory, Defaults to ./bin
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/h4ux/ctree/releases
...
get_binaries() {
  case "$PLATFORM" in
    darwin/amd64) BINARIES="ctree" ;;
    darwin/386) BINARIES="ctree" ;;
    linux/386) BINARIES="ctree" ;;
    linux/amd) BINARIES="ctree" ;;
    linux/amd64) BINARIES="ctree" ;;
    linux/arm) BINARIES="ctree" ;;
    linux/arm64) BINARIES="ctree" ;;
    *)
